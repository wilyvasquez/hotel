...
<html lang="en">
   ...
   <body>
         ...
         <div class="container">
            ...
            <div class="testimonial_slider owl-carousel">
               <div class="media testimonial_item">
                  <img class="rounded-circle" src="<?=base_url()?>assets/image/xtesttimonial-1.jpg" alt="">
         ...
         <div class="container">
            ...
            <div class="row mb_30">
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="single-recent-blog-post">
                     <div class="thumb">
                        <img class="img-fluid" src="<?=base_url()?>assets/image/blog/xblog-2.jpg" alt="post">
                     </div>
                     <div class="details">
                        <div class="tags">
                           <a href="#" class="button_hover tag_btn">Travel</a>
                     ...
                     <div id="mc_embed_signup">
                        <form target="_blank" action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&amp;id=92a4423d01" class="subscribe_form relative">
                           <div class="input-group d-flex flex-row">
                              <input name="EMAIL" placeholder="Direccion de correo" type="email">
      ...
      <script src="<?=base_url()?>assets/js/popper.js+bootstrap.min.js.pagespeed.jc.aCxZ2lnAlx.js"></script>
      <script>eval(mod_pagespeed_I6KtiD7z$f);</script>
      <script>eval(mod_pagespeed_ahg32vMnoq);</script>
      <script src="<?=base_url()?>assets/js/vendors,_owl-carousel,_owl.carousel.min.js+js,_jquery.ajaxchimp.min.js+js,_mail-script.js+vendors,_bootstrap-datepicker,_bootstrap-datetimepicker.min.js.pagespeed.jc.0iskldBnFt.js"></script>
      <script>eval(mod_pagespeed_h7GKHGEK1v);</script>
      ...
      <script src="<?=base_url()?>assets/js/vendors,_nice-select,_js,_jquery.nice-select.js+js,_mail-script.js+js,_stellar.js+vendors,_lightbox,_simpleLightbox.min.js+js,_custom.js.pagespeed.jc.AAP_0Kq5Mn.js"></script>
      <script>eval(mod_pagespeed_uxfKmGsidu);</script>
      <script>eval(mod_pagespeed_FTxQKjBzoX);</script>
