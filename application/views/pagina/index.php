...
<html lang="en">
   ...
   <body>
            ...
            <div class="row mb_30">
               <div class="col-lg-4 col-md-6">
                  <div class="single-recent-blog-post">
                     <div class="thumb">
                        <img class="img-fluid" src="<?=base_url()?>assets/image/blog/xblog-1.jpg" alt="post" data-pagespeed-url-hash="1679357639" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                     </div>
                     <div class="details">
                        <div class="tags">
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="single-recent-blog-post">
                     <div class="thumb">
                        <img class="img-fluid" src="<?=base_url()?>assets/image/blog/xblog-2.jpg" alt="post" data-pagespeed-url-hash="1973857560" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                     </div>
                     <div class="details">
                        <div class="tags">
                           <a href="#" class="button_hover tag_btn">Travel</a>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="single-recent-blog-post">
                     <div class="thumb">
                        <img class="img-fluid" src="<?=base_url()?>assets/image/blog/xblog-3.jpg" alt="post" data-pagespeed-url-hash="2268357481" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                     </div>
                     <div class="details">
                        <div class="tags">
                           <a href="#" class="button_hover tag_btn">Travel</a>
               ...
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="single-footer-widget instafeed">
                     ...
                     <ul class="list_style instafeed d-flex flex-wrap">
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-01.jpg" alt="" data-pagespeed-url-hash="2753632686" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-02.jpg" alt="" data-pagespeed-url-hash="3048132607" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-03.jpg" alt="" data-pagespeed-url-hash="3342632528" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-04.jpg" alt="" data-pagespeed-url-hash="3637132449" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-05.jpg" alt="" data-pagespeed-url-hash="3931632370" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-06.jpg" alt="" data-pagespeed-url-hash="4226132291" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-07.jpg" alt="" data-pagespeed-url-hash="225664916" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-08.jpg" alt="" data-pagespeed-url-hash="520164837" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <script src="<?=base_url()?>assets/js/vendors,_owl-carousel,_owl.carousel.min.js+js,_jquery.ajaxchimp.min.js+js,_mail-script.js+vendors,_bootstrap-datepicker,_bootstrap-datetimepicker.min.js.pagespeed.jc.0iskldBnFt.js"></script><script>eval(mod_pagespeed_h7GKHGEK1v);</script>
      ...
      <script defer src="https://static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"65d35a7aebf3d0d4","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.5.2","si":10}'></script>
   </body>
</html>