            ...
            <nav class="navbar navbar-expand-lg navbar-light">
               <a class="navbar-brand logo_h" href="index.html">
                   <script data-pagespeed-no-defer>//<![CDATA[
                     ...
                     pagespeed.CriticalImages.Run('/mod_pagespeed_beacon','https://preview.colorlib.com/theme/royal/contact.html','-ilGEe-FWC',true,false,'I2EpgPTK7cY');
                     //]]>
                  </script>
      ...
      <section class="gallery_area section_gap">
         <div class="container">
            <div class="section_title text-center">
               <h2 class="title_color">Gran Hotel Huatulco</h2>
               <p>Lorem ipsum dolor sit amet consectetur adipisicing, elit..</p>
            </div>
            <div class="row imageGallery1" id="gallery">
               <div class="col-md-4 gallery_item">
                  <div class="gallery_img">
                     <img src="<?=base_url()?>assets/image/01.jpg" alt="">
                     <div class="hover">
               ...
               <div class="col-md-4 gallery_item">
                  <div class="gallery_img">
                     <img src="<?=base_url()?>assets/image/02.jpg" alt="">
                     <div class="hover">
               ...
               <div class="col-md-4 gallery_item">
                  <div class="gallery_img">
                     <img src="<?=base_url()?>assets/image/03.jpg" alt="">
                     <div class="hover">
               ...
               <div class="col-md-4 gallery_item">
                  <div class="gallery_img">
                     <img src="<?=base_url()?>assets/image/04.jpg" alt="">
                     <div class="hover">
               ...
               <div class="col-md-4 gallery_item">
                  <div class="gallery_img">
                     <img src="<?=base_url()?>assets/image/06.jpg" alt="">
                     <div class="hover">
               ...
               <div class="col-md-4 gallery_item">
                  <div class="gallery_img">
                     <img src="<?=base_url()?>assets/image/05.jpg" alt="">
                     <div class="hover">
               ...
               <div class="col-md-4 gallery_item">
                  <div class="gallery_img">
                     <img src="<?=base_url()?>assets/image/01-1.jpg" alt="">
                     <div class="hover">
               ...
               <div class="col-md-4 gallery_item">
                  <div class="gallery_img">
                     <img src="<?=base_url()?>assets/image/02-1.jpg" alt="">
                     <div class="hover">
               ...
               <div class="col-md-4 gallery_item">
                  <div class="gallery_img">
                     <img src="<?=base_url()?>assets/image/03-1.jpg" alt="">
                     <div class="hover">
               ...
               <!-- <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="single-footer-widget instafeed">
                     ...
                     <ul class="list_style instafeed d-flex flex-wrap">
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-01.jpg" alt=""></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-02.jpg" alt=""></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-03.jpg" alt=""></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-04.jpg" alt=""></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-05.jpg" alt=""></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-06.jpg" alt=""></li>
                        <li><img src="<?=base_url()?>assets/image/instagram/xImage-07.jpg" alt=""></li>
